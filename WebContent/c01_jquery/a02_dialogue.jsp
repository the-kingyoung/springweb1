...
//
	$(document).ready(function(){
		...
		$("#detBtn").click(function(){
			...
			opts.width="500px";
			$("#dialog01").dialog(opts);	// 수정/삭제버튼 추가
			$("#dialog01").dialog("open");	// 기본 창 로딩
		});
	});
</script>
...
<div class="container">
	...
	<form class="form-inline" method="post">
		<button id="regBtn" 
			class="btn btn-success" type="submit">등록</button>
		<button id="detBtn" 
			class="btn btn-info" type="submit">상세화면</button>
	</form>
	</nav>
